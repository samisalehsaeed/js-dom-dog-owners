...
addNewDog.addEventListener("click", () => {
  ...
  form.addEventListener("submit", (event) => {
    ...
    dogs.addEventListener("click", () => {
      ...
      const h2 = document.createElement("h2");
      h2.innerText = newDog.name;
      dogsCards.append(h2);

      const image = document.createElement("img");
      image.setAttribute("src", newDog.image);
      ...
      bioInfo.innerText = newDog.bio;
      dogsCards.append(bioInfo);

      const naughty = document.createElement("p");
      naughty.innerText = `Is naughty? ${newDog.isGoodDog}`;
